...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles the VitalRecordNotFoundException
     *
     * @param ex
     * @param request
     * @return
     */
    @ExceptionHandler(VitalRecordNotFoundException.class)
    public ResponseEntity<ErrorDetails> handleUserNotFoundException(VitalRecordNotFoundException ex, WebRequest request) {
     ...
     * @return
     */
    @ExceptionHandler(DuplicateVitalRecordFoundException.class)
    public ResponseEntity<ErrorDetails> handleDuplicateUserException(DuplicateVitalRecordFoundException ex, WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(new Date(), ex.getMessage(), request.getDescription(false));
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorDetails);
    }
